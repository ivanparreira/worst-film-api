...
@Generated(
    ...
    date = "2022-01-18T16:18:12-0300",
    comments = "version: 1.3.1.Final, compiler: javac, environment: Java 11.0.13 (Ubuntu)"
)
@Component
public class WorstFilmMapperImpl implements WorstFilmMapper {
    ...
    @Override
    public Studio toModel(StudioDTO studioDTO) {
        if ( studioDTO == null ) {
            return null;
        }
